...
<template>
  <div class="ticktick-container">
    ...
    <div class="task-section completed-section" v-if="store.completedTasks.length > 0">
      <h4 class="section-title">已完成</h4>
      <ul class="task-list">
        <li v-for="task in store.completedTasks" :key="task.id" class="task-item completed">
          <label class="checkbox-container">
