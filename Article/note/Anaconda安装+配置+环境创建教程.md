...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-2e13bafb.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-74f58cf6.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-6fa5a17f.png)


### Step2:点击 I Agree


![image.png](/images/notion/Anaconda安装+配置+环境创建教程-fb1737da.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-47d8cebb.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-56c58e29.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-94bdf005.png)


### Step6:安装进行中，等待即可，这一步取决于电脑的性能。


![image.png](/images/notion/Anaconda安装+配置+环境创建教程-06dc5bba.png)


### Step7: 点击【Next】——再次点击【Next】


![image.png](/images/notion/Anaconda安装+配置+环境创建教程-b5ed9a57.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-15a51698.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-112d7c36.png)

> 选择环境变量

![image.png](/images/notion/Anaconda安装+配置+环境创建教程-2520a422.png)

> 系统变量选择path，双击进入

![image.png](/images/notion/Anaconda安装+配置+环境创建教程-370e4726.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-7db6e80f.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-36feb27a.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-35dddf36.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-55623c60.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-05ff1109.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-d9450ae1.png)


其次我们看镜像源也成功配置


![image.png](/images/notion/Anaconda安装+配置+环境创建教程-51520c51.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-daefe59e.png)
...
![image.png](/images/notion/Anaconda安装+配置+环境创建教程-3224c53d.png)


后来，经过不断搜索、尝试，发现这个问题是**火绒**的安全软件导致的。因为这个是单位的电脑，所以在其中安装了火绒软件，如下图所示。


![image.png](/images/notion/Anaconda安装+配置+环境创建教程-68e48bb2.png)


那么，解决方法就很简单了。大家可以在电脑右下角的火绒图标上右键，并选择“**退出火绒**”。如下图所示。


![image.png](/images/notion/Anaconda安装+配置+环境创建教程-c905e209.png)


随后，**Anaconda**的安装进度就应该可以动起来了。当然，可能得稍微等一下，我当初关掉火绒后，似乎等了可能半分钟，安装进度才开始继续执行。如下图所示。


![image.png](/images/notion/Anaconda安装+配置+环境创建教程-5d46de53.png)
